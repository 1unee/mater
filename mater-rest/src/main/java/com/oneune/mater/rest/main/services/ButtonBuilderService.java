    ...
    public SendMessage buildStartMessageWithOnlyText(Update update) {
        ...
        return SendMessage.builder()
                ...
                .text("""
                      ...
                      1) слева снизу есть кнопка %s - нужно нажать на нее
                      2) готово - вы прекрасны
                      
                      Учти, что первое открытие приложения может длиться дольше обычного,
                      потому что происходит начальная загрузка приложения, что
                      требует обычно больше времени.
